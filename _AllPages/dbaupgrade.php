                        ...
                        <div class="row align-items-center flex-row-reverse">
                            ...
                            <div class="col-lg-12 text-center">  
                                <div class="heading-wrapper wow fadeInLeft" data-wow-delay="0.2s">
                                    <h1 class="solutz-text herotextbg">DBA Consulting</h1>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="text-wrapper" style="text-align: justify;">
                                    <ul class="list-style-one">
                                        <li>Minor Version upgrades: release upgrades within same version. 
                                        </li>
                                        <li>Major Version upgrades: Version upgrade to a different higher versions. 
